...
public final class Solution {
	...
	/**
	 * printEnergies funcytion to print the energies of each pixel.
	 *
		...
		try {
			...
			case "removeVerticalSeam":
				while (scan.hasNextLine()) {
					...
					seamCarver = new SeamCarver(
					    new Picture("/Files/" + file));
					int[] vtseam = seamCarver.findVerticalSeam();
					seamCarver.removeVerticalSeam(vtseam);
					printSeam(seamCarver, vtseam, false);
				}
				break;
			...
			case "removeHorizontalSeam":
				while (scan.hasNextLine()) {
					...
					seamCarver.removeHorizontalSeam(
					    seamCarver.findHorizontalSeam());
					int[] hzseam = seamCarver.findHorizontalSeam();
					seamCarver.removeHorizontalSeam(hzseam);
					printSeam(seamCarver, hzseam, true);
				}
				break;
